...
export default function ExperienceSection() {
  ...
  return (
    <section id="experience" className="bg-white min-h-screen flex items-center justify-center py-20">
      <div className="max-w-7xl w-full px-8">
        <h2 className="font-['Alexandria:Bold',sans-serif] font-bold text-[#2f9ddc] text-[56px] tracking-[-1.12px] mb-16 text-center">
          EXPERIENCE
        </h2>
        <div className="flex gap-10">
            ...
            <div className="bg-[#2f9ddc] rounded-xl p-6 space-y-3">
              {experiences.map((exp, index) => (
                <button
                  ...
                  className={`w-full text-left px-6 py-4 rounded-lg font-['Alexandria:Bold',sans-serif] font-bold text-[18px] tracking-[-0.36px] transition-all duration-200 ${
                    selectedExperience === index
                      ? 'bg-[#29e7d1] text-[#32333c] shadow-lg'
                      : 'text-white hover:bg-white hover:bg-opacity-20 hover:text-[#2f9ddc]'
                  }`}
                >
                  <div className="text-[16px] mb-1">{exp.company}</div>
          ...
          <div className="flex-1">
            <div className="bg-[#f1fdff] p-10 rounded-xl border-l-4 border-[#29e7d1] min-h-[500px]">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <h3 className="font-['Alexandria:Bold',sans-serif] font-bold text-[#32333c] text-[32px] tracking-[-0.64px]">
                    {experiences[selectedExperience].title}
                  </h3>
                  <p className="font-['Alexandria:Bold',sans-serif] text-[#2f9ddc] text-[24px] tracking-[-0.48px]">
                    {experiences[selectedExperience].company}
                  </p>
                </div>
                <span className="font-['Alexandria:Bold',sans-serif] text-[#2f9ddc] text-[20px] tracking-[-0.4px]">
                  {experiences[selectedExperience].period}
                </span>
              </div>

              <div className="mb-6">
                <h4 className="font-['Alexandria:Bold',sans-serif] font-bold text-[#32333c] text-[22px] tracking-[-0.44px] mb-3 pb-2 border-b-2 border-[#29e7d1]">
                  Tasks:
                </h4>
                <ul className="space-y-2">
                  {experiences[selectedExperience].tasks.map((item, i) => (
                    <li
                      key={i}
                      className="font-['Alexandria:Bold',sans-serif] text-[#32333c] text-[18px] tracking-[-0.36px] flex items-start"
                    >
                      <span className="text-[#29e7d1] mr-3 text-[20px]">●</span>
                      <span>{item}</span>
                    </li>
                  ))}
                </ul>
              ...
              <div className="pt-4 border-t-2 border-[#29e7d1]">
                <span className="font-['Alexandria:Bold',sans-serif] font-bold text-[#2f9ddc] text-[18px] tracking-[-0.36px]">
                  References:{' '}
                </span>
                <span className="font-['Alexandria:Bold',sans-serif] text-[#32333c] text-[18px] tracking-[-0.36px]">
